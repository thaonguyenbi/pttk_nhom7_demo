...
<body>
                ...
                <div class="col-sm-8 col-lg-4 d-flex justify-content-end gap-5 align-items-center mt-4 mt-sm-0 justify-content-center justify-content-sm-end">
                    ...
                    <div class="cart text-end d-none d-lg-block dropdown">
                        <button class="border-0 bg-transparent d-flex flex-column gap-2 lh-1" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart">
                            ...
                            <span class="cart-total fs-5 fw-bold"><?= number_format($tamTinh, 0, ',', '.') ?>đ</span>
                        </button>
                    </div>
                </div>
    ...
    <div class="container-fluid mb-5" style=" background-color: rgba(177, 31, 78, 0.1)">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">ĐẶT MÓN</h1>
              ...
              ORDER BY chitietgiohang.MaCTGH ASC");
                    ...
                    <div class="card border-secondary mb-5">
                        <div class="card-footer border-secondary bg-transparent">
                            ...
                            <button type="submit" name="order" class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-3"
